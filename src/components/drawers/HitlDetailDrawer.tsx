...
export function HitlDetailDrawer({
  task,
  onClose,
  onDecision,
}: HitlDetailDrawerProps) {
  ...
  const handleDecision = async (decision: "Approved" | "Rejected") => {
    ...
    try {
      await submitHitlDecision(task.id, {
        decision,
        ...
        <div className="flex flex-col h-full">
          <div className="flex-1 p-6 overflow-y-auto">
            ...
            {isPending && (
              <div className="alert-warning mb-6">
                <div className="flex gap-3">
                  <svg
                    className="w-5 h-5 text-[var(--risk-medium)] flex-shrink-0 mt-0.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={1.5}
                    stroke="currentColor"
                  ...
                  <div>
                    <p className="text-sm font-medium text-[var(--risk-medium-text)]">
                      Action Pending Review
                    </p>
                    <p className="text-sm text-[var(--risk-medium-text)] opacity-80 mt-1">
            ...
            {!isPending && task.reviewerId && (
              <div className="bg-[var(--background-alt)] border border-[var(--card-border)] rounded-lg p-4 mb-6">
                ...
                <div className="space-y-2">
                  {action.reasons.map((reason, i) => (
                    ...
                    >
                      ...
                      <span className="text-[var(--risk-medium-text)]">
                        {reason}
                      </span>
                    </div>
                  ))}
...
└─ Decision: REQUIRE_HITL
    └─ Reason: Human judgment recommended`}
          ...
          {isPending && (
            <div className="p-6 border-t border-[var(--card-border)] bg-[var(--card)]">
              <div className="flex gap-3">
                <button
                  type="button"
