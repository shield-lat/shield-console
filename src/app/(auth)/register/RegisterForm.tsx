    ...
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[var(--foreground-muted)] mt-2">
          Get started with Shield Console for free
        </p>
      </div>
      ...
      <div className="space-y-3 mb-8">
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-[var(--card)] border border-[var(--card-border)] rounded-lg hover:bg-[var(--card-hover)] transition-colors disabled:opacity-50"
        >
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--foreground-muted)]">
              Start with 10,000 evaluations/month
            </p>
          </div>
        </div>
      ...
      {/* Terms */}
      <p className="text-xs text-center text-[var(--foreground-muted)] mb-6">
